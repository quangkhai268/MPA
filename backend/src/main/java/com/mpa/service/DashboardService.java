...
public interface DashboardService {
    ...
    List<PhongDataResponse> getPhongData(String loaiKy, String selectedKy, String soVoi, Integer denThangLuyKe);
    ...
    List<Integer> getNamLuyKeOptions(int nam);
    List<AmTopResponse> getTopAm(String loaiKy, String selectedKy, String soVoi, String metricKey, int limit);
    List<KhachHangTopResponse> getTopKh(String loaiKy, String selectedKy, String soVoi, String metricKey, int limit);
    BienDongKhResponse getBienDongKh(String loaiKy, String selectedKy, String soVoi, String metricKey, int limit);
}
